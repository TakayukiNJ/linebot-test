...
const LINE_TOKEN = 'gfLMLf+kcs9YHk0uWJdpAFjtgTyb4IeSd8qtP2Zb6Iewj7IQENFYUlLAt4PNQVsoyLm6zhN5oMIMpm2m8UXAjS/ZPuAjEoUjnHvcJwV3s3uU/uzXcIBoIdqFq6vrAzpVdEvYYH3S8wY7baoeHC9G3gdB04t89/1O/w1cDnyilFU='; // Messaging API設定の一番下で発行できるLINE Botのアクセストークン（Channel Secretはいらないみたいです。）
...
function doPost(e) {
  ...
  // ***************************
  // 最初のA列は、入力した時間を入れる
  const dateNow = Utilities.formatDate(new Date(), 'Asia/Tokyo', 'yyyy年MM月dd日');
